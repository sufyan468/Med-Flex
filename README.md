...
This is a boilerplate application for use across **Devigital Systems** based on React.
...
Further details around the organization of the code structure can be found [here](https://devigital.atlassian.net/wiki/spaces/EN/pages/137494529/Base+React+App+Documentation).x
